 ...
 */
class RdDActorSheet extends ActorSheet {
   ...
   */
	static get defaultOptions() {
	  ...
	  options.template = "../templates/actor-sheet.html";
    options.width = 600;
    options.height = 600;
	  return options;
  }
...
CONFIG.Actor.sheetClass = RdDActorSheet;
 ...
 */
class RdDItemSheet extends ItemSheet {
   ...
   */
	static get defaultOptions() {
	  ...
	  options.template = "public/systems/Rêve_de_Dragon/templates/item-sheet.html";
	  options.height = 400;
	  return options;
  }
...
CONFIG.Item.sheetClass = RdDItemSheet;
